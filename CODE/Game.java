...
public class Game extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        BG_Maze = new Image("images/BAC.png");
    ...
    private void loadGame() {
        ...
        player = new Pacman(playfieldLayer, image, x, y, 0, 0, 1, input, SoundE);
        ...
        En1 = new Enemy(playfieldLayer, image2, x, 280, 0, 0);
        En2 = new Enemy(playfieldLayer, image3, x + 20, 280, 0, 0);
        En3 = new Enemy(playfieldLayer, image4, x - 20, 280, 0, 0);
        En4 = new Enemy(playfieldLayer, image5, x, 260, 0, 0);
